...
contract SupplyChain {
  ...
  function harvestItem(uint _upc, address _originFarmerID, string memory _originFarmName, string memory _originFarmInformation, string memory _originFarmLatitude, string memory _originFarmLongitude, string memory _productNotes) public 
  {
    ...
    items[_upc] = Item(sku, _upc, _originFarmerID, _originFarmerID, _originFarmName, _originFarmInformation, _originFarmLatitude, _originFarmLongitude, _upc+sku, _productNotes,
                       0, State.Harvested, address(0), address(0), address(0));
    // Increment sku
    sku = sku + 1;
  ...
  checkValue(_upc)
  {
    ...
    items[_upc].ownerID = items[_upc].distributorID = msg.sender;
  ...
  // Access Control List enforced by calling Smart Contract / DApp
  {
    ...
    items[_upc].ownerID = items[_upc].retailerID = msg.sender;
  ...
  // Access Control List enforced by calling Smart Contract / DApp
  {
    ...
    items[_upc].ownerID = items[_upc].consumerID = msg.sender;
